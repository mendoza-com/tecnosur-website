<div class="notice notice-info is-dismissible <?php echo $this->plugin->name; ?>-review">
	<?php
	...
	<p>
		<a href="https://wordpress.org/support/plugin/<?php echo $this->plugin->name; ?>/reviews/?filter=5#new-post" class="button button-primary" target="_blank">
	...
	<script type="text/javascript">
		jQuery( document ).ready( function( $ ) {
	    	...
	    	$( 'div.<?php echo $this->plugin->name; ?>-review' ).on( 'click', 'a, button.notice-dismiss', function( e ) {
		        ...
		        // Hide notice
		        $( 'div.<?php echo $this->plugin->name; ?>-review' ).hide();
